...
router.put('/hacks/details', JWT.validateAdminToken, Handlers.hack.updateHackathonDetail);
router.delete('/hacks/details', JWT.validateAdminToken, Handlers.hack.deleteHackathonDetail);
router.get('/hacks/details/:hid', JWT.validateAdminToken, Handlers.hack.getHackathonDetails);
